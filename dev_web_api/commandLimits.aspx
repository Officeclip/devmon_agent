    ...
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <asp:Repeater ID="rptCommandLimits" runat="server">
                <ItemTemplate>
                    <tr>
                        <td><asp:Label ID="lblType" runat="server"
                             Text='<%# Eval("Type") %>' /></td>
                        <td><asp:TextBox ID="txtWarningLimit" runat="server" 
                             Text='<%# Eval("WarningLimit") %>' /></td>
                        <td><asp:TextBox ID="txtErrorLimit" runat="server" 
                            Text='<%# Eval("ErrorLimit") %>' /></td>
                        <td><asp:CheckBox ID="chkIsLowLimit" runat="server"
